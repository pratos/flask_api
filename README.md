...
__NOTE: This code is a bit old, please do not use this for production level tasks. There are better ways to do all these things, consider using [FlaskAppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) & [quart](https://github.com/pgjones/quart) or [FastAPI](https://github.com/tiangolo/fastapi) for your production apis__ 
